...
//            return RestResult.failure();
    ...
    public RestResult completeRepair(Authentication auth, Integer orderId, SysOrderArchiveVO sysOrderArchiveVO) {
        ...
        //
        sysOrderArchive.setCreteDatetime(Calendar.getInstance().getTime());
