<template>
	<view class="container">
		...
		<view class="form-group">
			<upload-image required title="正面及问题描述(只能上传1张图片)" upload_id="positiveItem" 
			@text-input="uploadText" @change="uploadImage" :title_style="uploadStyle"
			 :textarea_style="uploadStyle" :upload_style="uploadStyle" placeholder="在这写下手表正面的问题" ref="uploadImagePositive"></upload-image>
		</view>
		<view class="form-group">
			<upload-image required title="背面及问题描述(只能上传1张图片)" upload_id="backItem"
			 @text-input="uploadText" @change="uploadImage" :title_style="uploadStyle"
			 :textarea_style="uploadStyle" :upload_style="uploadStyle" placeholder="在这写下手表背面的问题" ref="uploadImageBack"></upload-image>
		</view>
		<view class="form-group">
			<upload-image required title="侧面及问题描述(只能上传1张图片)" upload_id="sideItem"
			 @text-input="uploadText" @change="uploadImage" :title_style="uploadStyle"
			 :textarea_style="uploadStyle" :upload_style="uploadStyle" placeholder="在这写下手表侧面的问题" ref="uploadImageSide"></upload-image>
		</view>
		<view class="form-group">
			<upload-image required title="故障面及问题描述(只能上传1张图片)" upload_id="problem"
			 @text-input="uploadText" @change="uploadImage" :title_style="uploadStyle"
			 :textarea_style="uploadStyle" :upload_style="uploadStyle" placeholder="在这写下手表故障面的问题" ref="uploadImageMalfunction"></upload-image>
		</view>
		<view class="form-group">
